...
"metaTitle" => array(
    "about.php" => "About us",
    "about" => "About us",
    "biens.php" => "Abroad properties",
    "biens" => "Abroad properties",
    "contact.php" => "Contact",
    "contact" => "Contact",
    "detail-bien.php" => "Property",
    "detail-bien" => "Property",
    "etranger.php" => "Our properties",
    "etranger" => "Our properties",
    ...
    "vendre-bien-immobilier-luxe-prestige.php" => "Verkaufe eine Immobilie",
    "vendre-bien-immobilier-luxe-prestige" => "Verkaufe eine Immobilie",
),
...
"btnMoreDetail" => "Detailliertes Blatt",
"contactInfo" => "Kontaktiere uns",
...
"RealEstateAgent"  => "Chartered real estate agent",
